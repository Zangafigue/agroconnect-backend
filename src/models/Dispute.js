...
const disputeSchema = new mongoose.Schema({
  ...
  reason:     { type: String, enum: ['NON_DELIVERED','DAMAGED','WRONG_QUANTITY','WRONG_PRODUCT','PAYMENT_ISSUE','OTHER'] },
  ...
  decision:   { type: String, enum: ['REFUND_BUYER','VALIDATE_DELIVERY','PARTIAL','NO_ACTION'] },
}, { timestamps: true });
